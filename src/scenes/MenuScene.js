    ...
    export default class MenuScene extends Phaser.Scene {
        ...
        create() {
            ...
            if (!this.sound.get('menuMusic')) {
                ...
                this.menuMusic.play();
                this.tweens.add({ targets: this.menuMusic, volume: 0.5, duration: 700 });
            }
            ...
            makeLeftButton(playY, 'COMEÇAR', 0xb8860b, () => { this.transitionTo('GameScene'); });
            makeLeftButton(playY + 96, 'DEFINIÇÕES', 0x8b6914, () => this.transitionTo('SettingsScene'));
            ...
            trophy.on('pointerdown', () => this.transitionTo('LeaderboardScene'));

            this.input.keyboard.on('keydown-SPACE', () => this.transitionTo('GameScene'));
            this.input.keyboard.on('keydown-ENTER', () => this.transitionTo('GameScene'));
